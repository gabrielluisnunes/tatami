...
export default function LoginPage() {
  ...
  const handleEmailLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Query role from profiles table (strictly)
      ...
      if (profileError || !profile) {
        // If profile does not exist or has no role, sign out and show error for security
      ...
      // Show generic/clear error messages to the user without disclosing database details
      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="bg-slate-900/40 backdrop-blur-xl border border-slate-800/80 rounded-2xl p-8 shadow-2xl space-y-6">
          ...
          <div className="relative flex py-2 items-center">
            ...
            <span className="flex-shrink mx-4 text-xs text-slate-500 uppercase tracking-widest">
              ou
            </span>
            <div className="flex-grow border-t border-slate-800"></div>
          </div>
